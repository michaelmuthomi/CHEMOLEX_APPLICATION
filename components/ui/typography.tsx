  ...
  ({ className, asChild = false, ...props }, ref) => {
    ...
    return (
      <Component
        ...
        aria-level="2"
        className={cn(
          "web:scroll-m-20 border-b border-border pb-2 text-3xl font-semibold tracking-tight first:mt-0 web:select-text",
          className
        )}
        ref={ref}
        {...props}
  ...
  ({ className, asChild = false, ...props }, ref) => {
    ...
    return (
      <Component
        ...
        aria-level="3"
        className={cn(
          "web:scroll-m-20 text-2xl font-semibold tracking-tight web:select-text",
          className
        )}
        ref={ref}
        {...props}
  ...
  ({ className, asChild = false, ...props }, ref) => {
    ...
    return (
      <Component
        ...
        aria-level="4"
        className={cn(
          "web:scroll-m-20 text-base tracking-normal leading-4 web:select-text",
          className
        )}
        ref={ref}
        {...props}
  ...
  ({ className, asChild = false, ...props }, ref) => {
    ...
    return (
      <Component
        ...
        aria-level="4"
        className={cn(
          "web:scroll-m-20 tracking-wide leading-4 web:select-text",
          className
        )}
        ref={ref}
        {...props}
  ...
  ({ className, asChild = false, ...props }, ref) => {
    ...
    return (
      <Component
        ...
        className={cn(
          "mt-6 native:mt-4 border-l-2 border-border pl-6 native:pl-3 text-base italic web:select-text",
          className
        )}
        ref={ref}
        {...props}
...
const Large = React.forwardRef<TextRef, SlottableTextProps>(
  ({ className, asChild = false, ...props }, ref) => {
    ...
    return (
      <Component
        className={cn(
          "text-xl font-semibold web:select-text",
          className
        )}
        ref={ref}
        {...props}
...
const Small = React.forwardRef<TextRef, SlottableTextProps>(
  ({ className, asChild = false, ...props }, ref) => {
    ...
    return (
      <Component
        className={cn(
          "text-sm font-medium leading-none web:select-text",
          className
        )}
        ref={ref}
        {...props}
